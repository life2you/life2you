...
- When a managed tool repository ships new release-flow or upgrade-flow capabilities, make sure those highlights are included in that version's GitHub Release page notes/changelog.
